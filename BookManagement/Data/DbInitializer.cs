...
namespace BookManagement.Data
{
    public class DbInitializer
    {
        public static void Initialize(BookContext context)
        {
            ...
            var books = new Book[]
            {
                new Book { Title = "The Da Vinci Code", Description = "The Da Vinci Code follows symbologist Robert Langdon and cryptologist Sophie Neveu after a murder in the Louvre Museum in Paris causes them to become involved in a battle between the Priory of Sion and Opus Dei over the possibility of Jesus Christ and Mary Magdalene having had a child together.", Year = DateTime.Parse("2003-04-01"), AuthorID = 1, GenreID = 1 },
                new Book { Title = "Harry Potter and the Deathly Hallows", Description = "The novel chronicles the events directly following Harry Potter and the Half-Blood Prince and the final confrontation between the wizards Harry Potter and Lord Voldemort.", Year = DateTime.Parse("2007-07-14"), AuthorID = 2, GenreID = 2 },
                new Book { Title = "Harry Potter and the Half-Blood Prince", Description = "Set during Harry Potter's sixth year at Hogwarts, the novel explores the past of the boy wizard's nemesis, Lord Voldemort, and Harry's preparations for the final battle against Voldemort alongside his headmaster and mentor Albus Dumbledore.", Year = DateTime.Parse("2005-07-16"), AuthorID = 2, GenreID = 2 },
                new Book { Title = "The Art of War", Description = "The book contains a detailed explanation and analysis of the 5th-century Chinese military, from weapons and strategy to rank and discipline. Sun also stressed the importance of intelligence operatives and espionage to the war effort. Considered one of history's finest military tacticians and analysts, his teachings and strategies formed the basis of advanced military training for millennia to come.", Year = DateTime.Parse("500-01-01"), AuthorID = 3, GenreID = 3 },
